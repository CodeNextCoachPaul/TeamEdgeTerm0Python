...
newList = ["pizza",5,5.01, False,["hi","bye"]
...
@@ -77,7 +84,12 @@ def times_ten(number):
...
print("------------------- CHALLENGE 6 -------------------")
@@ -125,7 +140,7 @@ def times_ten(number):
...
if len(numbers) > 3:
@@ -134,7 +149,9 @@ def times_ten(number):
...
if len(newItemsTwo) < 5:
           tup = ("Work It", "One Two Step")
           newItemsTwo.append(tup)

print("------------------- CHALLENGE 6 -------------------")

@@ -151,12 +168,15 @@ def times_ten(number):
...
splitSent = make_me_exciting.split(" ")
splitSent.append("!")
